...
def preprocess_wrapper(file_path):
    """Wrapper function for preprocess_video function to allow its use within a process pool"""
...
def run_inference_worker(
    ...
    """Wrapper function for inference pipeline class to allow its constructor to be called within a process pool"""
...
async def process_segments(
    ...
    with ProcessPoolExecutor(max_workers=max_workers) as process_pool:
        ...
        master_tasks = [process_one_segment(file_path) for file_path in file_paths]
